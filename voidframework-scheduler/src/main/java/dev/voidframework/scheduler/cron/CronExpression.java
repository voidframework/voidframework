...
public class CronExpression {
    ...
    final Map<String, String> MONTH_NAME_TO_VALUE = Map.ofEntries(
        Map.entry("JAN", "1"),
        Map.entry("FEB", "2"),
        Map.entry("MAR", "3"),
        Map.entry("APR", "4"),
    ...
    final Map<String, String> DAY_OF_WEEK_NAME_TO_VALUE = Map.ofEntries(
        Map.entry("SUN", "0"),
        Map.entry("MON", "1"),
        Map.entry("TUE", "2"),
        Map.entry("WED", "3"),
    ...
    final Map<DayOfWeek, Integer> DAY_OF_WEEK_CRON_VALUE = Map.ofEntries(
